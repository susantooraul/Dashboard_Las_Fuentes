...
function WellPumpIcon({ size = 16, ...props }: SVGProps<SVGSVGElement> & { size?: number | string }) {
  return (
    <svg
      width={size}
      height={size}
...
type SidebarIcon = LucideIcon | typeof WellPumpIcon;
...
function getIcon(key: string, iconKey?: string): SidebarIcon {
