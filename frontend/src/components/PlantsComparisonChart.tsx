...
export interface PlantsComparisonItem extends ChartDataPoint {
  id: string | number;
  name: string;
  currentLoad: number;
...
interface PlantsComparisonChartProps {
  plants: PlantsComparisonItem[];
}
      ...
      <div className="chart-tooltip-list">
        {consumption ? (
          <div className="chart-tooltip-row">
            <span className="chart-tooltip-dot" style={{ background: '#e9082c' } as React.CSSProperties} />
        ...
        {utilization ? (
          <div className="chart-tooltip-row">
            <span className="chart-tooltip-dot" style={{ background: '#f59e0b' } as React.CSSProperties} />
...
export default function PlantsComparisonChart({ plants }: PlantsComparisonChartProps) {
  return (
