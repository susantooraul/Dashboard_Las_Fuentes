...
export default function PlantDashboardCard({ plant }: PlantDashboardCardProps) {
  return (
    <article className="panel plant-dashboard-card fade-up">
      ...
      <div className="capacity-progress">
        <div className="capacity-progress-track">
          <div className={`capacity-progress-fill ${plant.indicatorClass}`} style={{ width: `${plant.utilizationPct}%` } as React.CSSProperties} />
        </div>
      </div>
