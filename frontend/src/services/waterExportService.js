...
function sanitizeCssForCanvas(cssText = '') {
...
async function inlineImagesForCanvas(html) {
...
function buildDomReport(section, context = {}) {
  const root = getExportRoot();
...
async function exportImage(report) {
...
export const downloadWaterReport = async (section, format, context = {}) => {
